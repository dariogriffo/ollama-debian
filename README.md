...
<p align="center">
⭐⭐⭐ Love using ollama on Debian? Show your support by starring this repo or [subscribing](https://buy.stripe.com/aFa28q8hr0lRdlm4a2enS01) — from 1 October 2026, apt access requires a yearly subscription. ⭐⭐⭐
</p>
...
> the .deb from the [Releases](https://github.com/dariogriffo/ollama-debian/releases) page
